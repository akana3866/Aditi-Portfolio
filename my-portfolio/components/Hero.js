      ...
      <div className="px-12 py-16 flex flex-col justify-center items-center gap-16 min-h-[700px]">
        <div className="w-full flex flex-col justify-center items-end gap-9">
          <div className="w-full flex justify-start items-center gap-3">
            <h1 className="text-black text-7xl md:text-8xl font-serif capitalize leading-tight">
              Hello, I&apos;m Aditi
            </h1>
            <div className="w-9 h-9 bg-black rounded-sm"></div>
          </div>
          <div className="w-full flex justify-end">
            <div className="flex flex-col gap-6 max-w-3xl">
              <p className="text-black text-2xl md:text-3xl font-medium leading-relaxed">
              ...
              <div>
                <span className="text-black text-xs">pronunciation: </span>
                <span className="text-black text-xs font-medium">uh·thi·thee</span>
              </div>
            </div>
          </div>
        </div>
